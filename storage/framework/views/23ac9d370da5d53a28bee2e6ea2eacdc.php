...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.form.label','data' => ['name' => $name]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
    ...
    <textarea id="<?php echo e($name); ?>" name="<?php echo e($name); ?>" rows="5"
        class="outline-none text-sm border border-gray-400 p-2 w-full rounded-xl"><?php echo e($value ?? old($name)); ?></textarea>
...
<?php endif; ?>
<?php /**PATH C:\Users\ibrahim dev\Desktop\shoping_online\resources\views/components/form/textfield.blade.php ENDPATH**/ ?>