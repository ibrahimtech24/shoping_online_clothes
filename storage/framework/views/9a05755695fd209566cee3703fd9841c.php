...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.structure','data' => ['heading' => 'category','model' => 'categories']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['heading' => 'category','model' => 'categories']); ?>
        ...
        <tbody class="divide-y divide-gray-100">
            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr class="bg-white">
                    ...
                    <td class="p-3 text-sm text-gray-700 whitespace-nowrap text-center">
                        <?php echo e($category->created_at->format('Y-m-d H:i:s')); ?></td>
                    <td class="p-3 text-sm text-gray-700 whitespace-nowrap text-center">
                        <?php echo e($category->updated_at->format('Y-m-d H:i:s')); ?></td>
                    <td
                        class="flex justify-center items-center space-x-2 p-3 text-sm text-gray-700 whitespace-nowrap text-center">
                        <a href="<?php echo e(route('dashboard.categories.edit', ['category' => $category])); ?>"><i
                                class="fa-solid fa-pen-to-square fa-lg"></i></a>

                        <form action="<?php echo e(route('dashboard.categories.delete', ['category' => $category])); ?>"
                            method="POST">
                            <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\ibrahim dev\Desktop\shoping_online\resources\views/dashboard/categories/index.blade.php ENDPATH**/ ?>