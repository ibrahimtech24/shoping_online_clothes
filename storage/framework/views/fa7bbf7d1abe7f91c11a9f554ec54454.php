...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['name', 'value', 'type' => 'text', 'disable' => false]));
...
foreach (array_filter((['name', 'value', 'type' => 'text', 'disable' => false]), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<?php endif; ?>
<?php /**PATH C:\Users\ibrahim dev\Desktop\shoping_online\resources\views/components/form/input.blade.php ENDPATH**/ ?>