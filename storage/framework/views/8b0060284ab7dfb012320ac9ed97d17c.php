...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.structure','data' => ['heading' => 'user','model' => 'users']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['heading' => 'user','model' => 'users']); ?>
        ...
        <tbody class="divide-y divide-gray-100">
            <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr class="bg-white">
                    ...
                    <td class="p-3 text-sm text-gray-700 whitespace-nowrap text-center">
                        <?php echo e($user->role == 1 ? 'Admin' : 'Normal User'); ?>

                    </td>
                    <td class="p-3 text-sm text-gray-700 whitespace-nowrap text-center">
                        <?php echo e($user->created_at->format('Y-m-d H:i:s')); ?></td>
                    <td class="p-3 text-sm text-gray-700 whitespace-nowrap text-center">
                        <?php echo e($user->updated_at->format('Y-m-d H:i:s')); ?></td>
                    <td
                        class="flex justify-center items-center space-x-2 p-3 text-sm text-gray-700 whitespace-nowrap text-center">
                        <a href="<?php echo e(route('dashboard.users.edit', ['user' => $user])); ?>"><i
                                class="fa-solid fa-pen-to-square fa-lg"></i></a>

                        <form action="<?php echo e(route('dashboard.users.delete', ['user' => $user])); ?>" method="POST">
                            <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\ibrahim dev\Desktop\shoping_online\resources\views/dashboard/users/index.blade.php ENDPATH**/ ?>