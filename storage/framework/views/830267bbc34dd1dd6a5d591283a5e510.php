...
<?php $component->withAttributes(['pd' => 'false']); ?>
    <div class="min-h-[calc(100vh-5rem)] flex items-center justify-center py-8 sm:py-12 px-4">
        ...
        <div class="absolute inset-0 overflow-hidden pointer-events-none">
            <div class="absolute top-20 right-10 w-64 h-64 bg-accent-400/10 rounded-full blur-3xl"></div>
            <div class="absolute bottom-20 left-10 w-80 h-80 bg-primary-400/10 rounded-full blur-3xl"></div>
        </div>
        ...
        <div class="w-full max-w-md relative z-10">
            ...
            <div class="glass-card rounded-3xl shadow-2xl shadow-dark-900/10 border border-white/20 p-6 sm:p-8">
                ...
                <div class="text-center mb-8">
                    ...
                    <h1 class="text-2xl sm:text-3xl font-bold text-dark-900">دروستکردنی هەژمار</h1>
                    <p class="text-dark-400 mt-2 text-sm sm:text-base">ئەمڕۆ بەشداری سناپ ستایل بکە</p>
                </div>

                
                <form action="<?php echo e(route('register')); ?>" method="POST" class="space-y-5 sm:space-y-6">
                    <?php echo csrf_field(); ?>

                    <div>
                        <label for="name" class="block text-sm font-medium text-dark-900 mb-2">ناوی تەواو</label>
                        <div class="relative">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="password" id="password" name="password"
                                   class="w-full pr-12 pl-4 py-3 sm:py-3.5 border-2 border-dark-200 rounded-xl focus:border-primary-500 focus:ring-0 outline-none transition-colors bg-white text-dark-900"
                                   placeholder="وشەی تێپەڕی بەهێز دروستبکە">
                        </div>
                        <?php if (isset($component)) { $__componentOriginal8a61cf4ce6144d9e2012fbc98db0155f = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal8a61cf4ce6144d9e2012fbc98db0155f = $attributes; } ?>
...
<?php endif; ?>
                ...
                <p class="text-center text-dark-400 text-sm sm:text-base">
                    هەژمارت هەیە؟
                    <a href="<?php echo e(route('login')); ?>" class="text-primary-500 font-semibold hover:text-primary-600 transition-colors">چوونە ژوورەوە</a>
                </p>
            </div>
        </div>
    </div>
...
<?php endif; ?>
<?php /**PATH C:\Users\ibrahim dev\Desktop\shoping_online\resources\views/register/create.blade.php ENDPATH**/ ?>