                        ...
                        <div class="relative h-full flex items-center justify-center text-center px-8">
                            <div class="max-w-4xl">
                                <div class="inline-flex items-center gap-3 px-6 py-3 bg-white/10 backdrop-blur-xl rounded-full border border-white/20 mb-8">
                                    ...
                                    <span class="text-white font-bold text-sm uppercase tracking-wider">{{ app()->getLocale() == 'ku' ? 'فرۆشگای لوکس' : 'PREMIUM STORE' }}</span>
                                    <div class="w-3 h-3 bg-gradient-to-r from-cyan-400 to-blue-500 rounded-full animate-pulse"></div>
                                </div>
                                ...
                                <h1 class="text-6xl md:text-7xl lg:text-8xl font-black mb-6 leading-none">
                                    ...
                                    <span class="block bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent mt-2">
                                        {{ app()->getLocale() == 'ku' ? '2026 فەشن' : '2026 FASHION' }}
                                    </span>
                                </h1>
                                
                                <p class="text-2xl text-white/90 mb-8 max-w-3xl mx-auto leading-relaxed">
                                    {{ app()->getLocale() == 'ku' ? 'جوانترین و باشترین ستایلەکان بە نرخی نایاب' : 'Most beautiful and best styles at incredible prices' }}
                                </p>
                                ...
                                <div class="flex flex-col sm:flex-row gap-6 justify-center">
                                    <button class="group px-10 py-5 bg-gradient-to-r from-white to-gray-100 text-gray-900 font-bold rounded-2xl text-xl shadow-xl hover:shadow-2xl transform hover:-translate-y-2 hover:scale-105 transition-all duration-300">
                                        <span class="flex items-center justify-center gap-3">
                                            🛍️ {{ app()->getLocale() == 'ku' ? 'ئێستا بکڕە' : 'SHOP NOW' }} ✨
                                        </span>
                                    </button>
                    ...
                    <div class="carousel-slide absolute inset-0 transition-all duration-1000 opacity-0">
                        ...
                        <div class="relative h-full flex items-center justify-center text-center px-8">
                            <div class="max-w-4xl">
                                ...
                                <h1 class="text-6xl md:text-7xl lg:text-8xl font-black mb-6 leading-none">
                                    <span class="block bg-gradient-to-r from-white to-gray-200 bg-clip-text text-transparent">
                                        {{ app()->getLocale() == 'ku' ? 'لوکس ستایل' : 'LUXURY STYLE' }}
                                    </span>
                                    <span class="block bg-gradient-to-r from-pink-400 to-purple-500 bg-clip-text text-transparent mt-2">
                                        {{ app()->getLocale() == 'ku' ? 'کوالیتی بەرز' : 'PREMIUM QUALITY' }}
                                    </span>
                                </h1>
                                
                                <p class="text-2xl text-white/90 mb-8 max-w-3xl mx-auto leading-relaxed">
                                    {{ app()->getLocale() == 'ku' ? 'دیزاینی جیهانی بە مادەی باشترین' : 'World-class design with finest materials' }}
                                </p>
                            ...
                            <div class="max-w-4xl">
                                ...
                                <h1 class="text-6xl md:text-7xl lg:text-8xl font-black mb-6 leading-none">
                                    ...
                                    <span class="block bg-gradient-to-r from-orange-400 to-red-500 bg-clip-text text-transparent mt-2">
                                        {{ app()->getLocale() == 'ku' ? 'گەرم و پۆپولار' : 'HOT & POPULAR' }}
                                    </span>
                                </h1>
                                
                                <p class="text-2xl text-white/90 mb-8 max-w-3xl mx-auto leading-relaxed">
                                    {{ app()->getLocale() == 'ku' ? 'هەرەباشترین مۆدای ئەم وەختە' : 'The hottest fashion trends right now' }}
                                </p>
        ...
        <div class="container mx-auto px-4 relative">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-20">
                ...
                <div class="group relative">
                    ...
                    <div class="relative bg-gradient-to-br from-white/15 via-white/10 to-white/5 backdrop-blur-2xl rounded-2xl overflow-hidden shadow-2xl hover:shadow-purple-500/30 transition-all duration-500 border border-white/20 hover:border-purple-300/50 transform hover:-translate-y-4 hover:scale-105">
                        ...
                        <div class="relative h-72 overflow-hidden">
                            ...
                            <div class="absolute top-4 left-4">
                                <span class="px-4 py-2 bg-gradient-to-r {{ $product['color'] }} text-white text-xs font-black rounded-full shadow-lg animate-bounce">
                                    {{ $product['badge'] }}
                                </span>
                            </div>
                        ...
                        {{-- Enhanced Content --}}
                        <div class="p-6">
                            <h3 class="text-xl font-black text-white mb-3 group-hover:text-purple-300 transition-colors">{{ $product['name'] }}</h3>
                            
                            {{-- Price Section --}}
                            <div class="flex items-center justify-between mb-4">
                                <div class="flex items-center gap-3">
                                    <span class="text-gray-400 line-through text-sm">{{ $product['old'] }}</span>
                                    <span class="text-2xl font-black text-transparent bg-gradient-to-r {{ $product['color'] }} bg-clip-text">{{ $product['price'] }}</span>
                                </div>
                            ...
                            <button class="w-full px-6 py-3 bg-gradient-to-r {{ $product['color'] }} text-white font-bold rounded-xl shadow-lg hover:shadow-lg transform hover:-translate-y-1 transition-all duration-300 text-sm group-hover:scale-105">
                    ...
                    {{-- External Card Glow --}}
                    <div class="absolute inset-0 bg-gradient-to-br {{ $product['color'] }}/20 rounded-2xl opacity-0 group-hover:opacity-100 blur-xl transition-all duration-500 -z-10"></div>
                </div>
                @endforeach
            </div>
